...
const StudentDashboard = () => {
  ...
  const [dashboardData, setDashboardData] = useState({
    upcomingSessions: { todayWeekday: "", sessions: [] },
    recentMessages: [],
    myTutors: [],
    pastAssignments: [],
    analytics: null,
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="p-4">{renderUpcomingSessions()}</div>
            </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div className="border border-gray-100 rounded-lg p-3">
                        ...
                        <div className="text-lg font-semibold text-gray-800">
                          {dashboardData.analytics.completedSessions || 0}/
                          {dashboardData.analytics.totalSessions || 0}
                        </div>
                      ...
                      <div className="border border-gray-100 rounded-lg p-3">
                        ...
                        <div className="text-lg font-semibold text-gray-800">
                          {dashboardData.analytics.submittedAssignments || 0}/
                          {dashboardData.analytics.totalAssignments || 0}
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                          <div
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-xs font-medium text-gray-700">
                            {dashboardData.analytics.assignmentStatusData
                              ?.assigned || 0}
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
                    ...
                    <div className="border-t border-gray-100 pt-4 mt-4">
                      ...
                      <div className="flex justify-between items-center mb-3">
                        ...
                        <span className="text-sm font-semibold text-blue-700">
                          {dashboardData.analytics.totalSessions}
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between items-center mb-3">
                        ...
                        <span className="text-sm font-semibold text-green-600">
                          {dashboardData.analytics.submittedAssignments} /{" "}
                          {dashboardData.analytics.totalAssignments}
                        </span>
                      </div>
                  ...
                  <div className="border border-blue-100 rounded-lg p-4 flex items-center gap-3 hover:bg-blue-50 transition-all cursor-pointer">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        See your booking details and history.
                      </p>
                    </div>
                  </div>
                </div>
